							...
							<tbody id="postList">
								<c:forEach var="post" items="${posts}">
										<tr>
												...
												<td><div class="tdDiv">${post.title}</div></td>
												<td><div class="tdDiv">${fn:substring(post.content, 0, 20)}${post.content.length() > 20 ? '...' : ''}</div></td>
												<td>
														<div class="tdDiv">
																<!-- <button class="deletebtn" onclick="viewPost(${post.postIdx})">보기</button> -->
																<button onclick="deletePost(${post.postIdx})">보기</button>
