	...
	<div class="post">
			<form action="/api/post/issave" method="post" enctype="multipart/form-data">
				...
				<div>
					...
					<hr><br>
					<textarea id="writePostContent" name="content" rows="7" placeholder="Content" required></textarea>
					...
					<button type="button" id="imageAddBtn" class="btn" onclick="addImage()"><img id="addImageIcon" src="/image/icon/fileupload.png">&nbsp;Add a picture</button>
