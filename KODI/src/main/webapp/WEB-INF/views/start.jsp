...
<body>
	...
	<main>
		<div class="logo-container">
			<img src="/image/logo.png" alt="KoDi">
		</div>
		<!-- 회원가입 -->
		...
		<div class="image-container">
			환영합니다!<br>
			<br> KoDi(Korea-Director)는 여러분이 한국 여행을<br> 더욱 편리하게 즐길 수 있도록<br>
			경험을 공유하고 소통하는 플랫폼입니다.<br>
	...
	<div class="page1-box">
		<div class="textbox">
			KoDi는 기다리고 있어요<br> 준비가 되셨나요? 회원가입을 하려면 이메일 주소를 입력하세요.
		</div>
